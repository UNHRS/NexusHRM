import { BarChart3, Building2, CalendarCheck, ClipboardCheck, LogOut, Menu, Network, Users, X } from 'lucide-react';
import { NavLink, useLocation, useNavigate } from 'react-router-dom';
import { useState } from 'react';
import { useAuth } from '../context/AuthContext.jsx';

const nav = {
  ADMIN: [['Overview', '/admin/dashboard', Building2, 'Overview'], ['Employees', '/admin/employees', Users, 'People'], ['Departments', '/admin/departments', Network, 'People'], ['Leave approvals', '/manager/leave-approvals', ClipboardCheck, 'Time & leave'], ['Reports', '/reports', BarChart3, 'Finance']],
  ...
  EMPLOYEE: [['My overview', '/employee/dashboard', Building2, 'Overview'], ['My profile', '/employee/profile', Users, 'People'], ['Attendance', '/employee/attendance', CalendarCheck, 'Time & leave'], ['My leave', '/employee/leave', ClipboardCheck, 'Time & leave']]
};
